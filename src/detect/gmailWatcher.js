 ...
 * { html, text, subject, headers }. `headers` is the raw payload header array,
 * needed for attribution (Delivered-To / X-Forwarded-For / etc.).
 */
export function decodeGmailMessage(message) {
  ...
  return { html, text, subject, headers };
}
